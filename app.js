...
app.post('/user',loginValid, async (req, res) => {
    ...
    else
    {
        ...
        const sortfound = new Map([...found.entries()].sort((a,b) => b[1] - a[1]));// sort map in descending order of value
        res.render('result',{sum: total, hits: sortfound, sortkeys: keys});
    }
});
